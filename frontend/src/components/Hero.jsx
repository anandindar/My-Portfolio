      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <div className="social-links">
            ...
            <a href="tel:8933028358" title="Phone">
              <FaPhone />
            </a>
            <a href="https://anandindar.github.io" target="_blank" rel="noopener noreferrer" title="GitHub">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/anand-kumar-gupta" target="_blank" rel="noopener noreferrer" title="LinkedIn">
              <FaLinkedin />
            </a>
          </div>
        </div>
